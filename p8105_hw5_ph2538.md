...
prop_city <- function(total.prop, unsolved.prop) {
...
```
    ...
    ## # A tibble: 50 x 6
    ##    city_state      total unsolved estimate conf_low conf_high
...
![](p8105_hw5_ph2538_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
